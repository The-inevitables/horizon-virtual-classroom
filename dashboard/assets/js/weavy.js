$(function () {
    ...
    var weavy = new Weavy({
        jwt: generateJWT("akshay", "akshay@97")
    });
...
function generateJWT(sub, email) {
    var secretString = "myclientsecret";
    ...
    return KJUR.jws.JWS.sign(null, { alg: "HS256", typ: "JWT" }, { iss: "myclientid",name:"akshay",password:"akshay@97",client_id:"myclientid","client_secret": "myclientsecret", sub: "myclientid", email: "akshayvanil117@gmail.com", exp: dateSoon.getTime() / 1000 }, secretString);
}